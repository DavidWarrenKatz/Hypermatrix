...
If MATLAB is not available, the software defaults to using the 'non_negative_parafac' function from the Python package Tensorly for low-rank decomposition. However, please be aware that this approach may not maintain symmetry in the genomic component, potentially affecting accuracy. In practice, this does not seem to be an issue. To my knowledge, only the Tensorlab package in MATLAB has implemented symmetric low-rank non-negative tensor factorization.
...
<div style="display: flex; justify-content: center;">
    <img src="files/approx_sum.png" width="200" height="auto">
</div>
...
<div style="display: flex; justify-content: center;">
    <img src="files/cumulant.png" width="600" height="auto">
</div>
