...
for resolution in resolutions:
    for ch in chromosomes:
        ...
        output_path = path + f'Workspaces/bigWigs/ch{ch}_res{resolution}_Hypermatrix_Tad_10Downsampled_oe_log2_KR_first4_200iterations.bigwig'
        ...
        bed_filename = path + f'boundaries/filtered_valleys_res{resolution}_ch{ch}_oe_log2_KR_threshold_{threshold}_scanning_{scanning_window}.bed'
