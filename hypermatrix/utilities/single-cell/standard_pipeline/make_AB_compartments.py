...
from config import methy_directory, filtered_list, chrom_file, resolutions, output_directory, mappability_threshold, normalization, software_directory, reference_genome
...
#4       sc10.TAGCTT     blue
#
filename = '{output_directory}/../../src/name.order.HCG_methy.with_color.txt'
...
###########################################################################
bulk_data = {}
path_to_eigenvectors = '{output_directory}/eigenvector/'
...
output_file = f'{output_directory}/../../src/softwarefiles/h3k9ac_res{resolution}_GM12878.pkl'
...
if not os.path.exists(output_file):
    ...
    bigwig_H3K9ac_path = '{output_directory}/../../src/softwarefiles/ENCFF128UVW_hg19_H3K9ac_GM12878.bigWig'
...
original_bulk_data_output_file = f'{output_directory}/original_bulk_data_res{resolution}.pkl'
...
# Save original_bulk_data to a file
bulk_data_output_file = f'{output_directory}/nan_removed_bulk_data_res{resolution}.pkl'
...
chromosome_results_output_file = f'{output_directory}/chromosome_results_res{resolution}.pkl'
