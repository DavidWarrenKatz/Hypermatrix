...
for resolution = resolutions
    for i = 1:numel(chromosomes)
        ...
        file_path = sprintf('%sWorkspaces/signal_p_value_H3K4me1_%d_res1000000_small_10000_ks_p_value_correlation.h5, path, chromosome);
        ...
        output_file = sprintf('%sWorkspaces/individual/ch%s_res%d_structedData_2Downsampled_H3K9me3_fold_change_small_10000_first3_300iterations.mat', path, chromosome, resolution);
        save(output_file);
     end
end
