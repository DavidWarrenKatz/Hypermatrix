...
base_tensor_dir = os.path.join(output_directory, f'tensor_{resolution_label}_AB_factors_cumulant')
...
for i in range(1, 23):
    ...
    for prefix in prefixes:
        ...
        output_dir = os.path.join(output_directory, f'tensor_{resolution_label}_AB_calls_cumulant', chromosome)
        sample_id = prefix 
...
chromosome_results_output_file = f'../../projects/single_cell_files/chromosome_results_res{resolution}_cumulant.pkl'
